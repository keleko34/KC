...
module.exports = function(res,cb){
  ...
  .pipe(gulp.dest('./.core'))
  .on('end',function(){
    console.log('\033[36mCompiling:\033[37m',' .core-cms');
    return gulp.src(_file.replace('.js','.build.js'))
    .pipe(closureCompiler({
      compilerPath:"./compiler.jar",
      fileName:".core-cms.min.js",
      warning_level: 'QUIET'
    }))
    .pipe(gulp.dest('./.core'))
    .on('end',cb);
