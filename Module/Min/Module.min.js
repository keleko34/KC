var CreateModule=function(){return function(p,q){function c(){var a,b=c.childModules(),g=Object.keys(b),e;for(a=0;a<g.length;a+=1)e=b[g[a]],void 0!==e&&e.apply(this,arguments)}var A=function(){return function(){function a(x){var b=a.isConstructor(),c=a.isFunction(),d=a.value(),e=a.isModuleScoped(),g=a.module(),f,h;f=a["type"+t](x);if(void 0===x||c||b)return c||b?b?(g=Array.prototype.slice.call(arguments),g.unshift(0),new (d.bind.apply(d,g))):e?d.apply(g,arguments):d.apply(d,arguments):d;if(f.isValid)for(d=
a.propertyName(),b=a.sharedModules(),c=Object.keys(b),e={stopPropagation:function(){this._stopPropagation=!0},value:x,propertyName:d,_stopPropagation:!1,changeOrigin:g},e.stopPropagation.bind(e),a.value(f.value),f=0;f<c.length&&!e._stopPropagation;f+=1)void 0!==b[c[f]]&&(h=b[c[f]][d],h.isModuleScoped()?h.onChange().call(h.module(),e):h.onChange().call(h.onChange(),e));return g}var b="",c,e,h,d=!1,f=!1,k=!1,l=!0,m=!0,n=function(){},p,y={},q=!1,r=!0,z={},t="string",w="string number object boolean function float array class".split(" "),
u=function(){};a.propertyName=function(a){if(void 0===a)return b;b=a.toString();return this};a.value=function(a){if(void 0===a)return c;c=a;return this};a.module=function(a){if(void 0===a)return e;e=a;return this};a.moduleName=function(a){if(void 0===a)return h;h=a.toString();return this};a.isPrivate=function(a){if(void 0===a)return d;d=!!a;return this};a.isFunction=function(a){if(void 0===a)return f;f=!!a;return this};a.configurable=function(a){if(void 0===a)return k;k=!!a;return this};a.enumerable=
function(a){if(void 0===a)return l;l=!!a;return this};a.writable=function(a){if(void 0===a)return m;m=!!a;return this};a.onChange=function(a){if(void 0===a)return n;n="function"===typeof a?a:function(){};return this};a.loadedFrom=function(a){if(void 0===a)return p;p=a;return this};a.sharedModules=function(a,b){if(void 0===a)return y;if(void 0===b)return y=a,this;y[a]=b;return this};a.isConstructor=function(a){if(void 0===a)return q;q=!!a;return this};a.isModuleScoped=function(a){if(void 0===a)return r;
r=!!a;return this};a.type=function(b){if(void 0===b)return t;t=-1<w.indexOf(b)?v:t;return a};a.typeClass=function(b){if(void 0===b)return u;u="function"===typeof b?b:u;return a};a.prototype=function(b,c){if(void 0===b)return z;if(void 0===c)return z=b,a.value().prototype=b,this;z[b.toString()]=c;a.value().prototype[b.toString()]=c;return this};a.typestring=function(a){return{isValid:"string"===typeof a||"[Object object]"!==a.toString(),value:a.toString()}};a.typenumber=function(a){return{isValid:"number"===
...
Array.toString(),value:a}};a.typeclass=function(a){return{isValid:a.toString()===u.toString(),value:a}};a.typepath=function(a){return{isValid:"string"===typeof a&&(0===a.indexOf("/")||1===a.indexOf(":")),value:a}};return a}}(),r="",w="",l={},m={},n={};c.setModuleName=function(a){if(void 0===a)return r;r=a;return c};c.setModule=function(a){if(void 0===a)return w;w=a;var b={};b.moduleName=c.setModuleName;b.parentModules=c.parentModules;b.createGetSetFunction=c.createGetSetFunction;Object.defineProperty(a,
